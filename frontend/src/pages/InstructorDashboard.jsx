...
import { GraduationCap, BookOpen, Users, Calendar, LogOut } from 'lucide-react';
            ...
            <div className="bg-white dark:bg-gray-800 shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="mt-2 max-w-xl text-sm text-gray-500 dark:text-gray-400">
                  <p>
                    You have successfully logged in as an instructor. From here you can manage your courses, view student progress, and create assignments.
                  </p>
                </div>
              </div>
            </div>
